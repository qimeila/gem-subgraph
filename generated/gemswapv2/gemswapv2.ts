...
export class gemswapv2__affiliatesResult {
  value0: Address;
  value1: boolean;
...
export class gemswapv2__sponsoredMarketsResult {
  value0: BigInt;
  value1: boolean;
...
export class gemswapv2 extends ethereum.SmartContract {
  static bind(address: Address): gemswapv2 {
    return new gemswapv2("gemswapv2", address);
  }
  ...
  affiliates(param0: BigInt): gemswapv2__affiliatesResult {
    ...
    return new gemswapv2__affiliatesResult(
      result[0].toAddress(),
      result[1].toBoolean()
    );
  }
  ...
  try_affiliates(
    param0: BigInt
  ): ethereum.CallResult<gemswapv2__affiliatesResult> {
    ...
    return ethereum.CallResult.fromValue(
      new gemswapv2__affiliatesResult(
        value[0].toAddress(),
        value[1].toBoolean()
      )
    );
  ...
  sponsoredMarkets(param0: BigInt): gemswapv2__sponsoredMarketsResult {
    let result = super.call(
      "sponsoredMarkets",
    ...
    return new gemswapv2__sponsoredMarketsResult(
      result[0].toBigInt(),
      result[1].toBoolean()
    );
  }
  ...
  try_sponsoredMarkets(
    param0: BigInt
  ): ethereum.CallResult<gemswapv2__sponsoredMarketsResult> {
    let result = super.tryCall(
      "sponsoredMarkets",
      "sponsoredMarkets(uint256):(uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new gemswapv2__sponsoredMarketsResult(
        value[0].toBigInt(),
        value[1].toBoolean()
      )
    );
